...
class Button extends React.Component {
    constructor() {
        ...
        this._onClick = (e) => {
            if (this.props.fileUpload)
                return this.refs.fileInput['click'](e);
    ...
    get icon() {
        return this.state.loading ?
            React.createElement("i", { className: "material-icons loading" }, "cached") :
    ...
    render() {
        ...
        return (React.createElement(El, { className: classNames('react-btn', this.props.className, this.props.mode, this.props.size, { disabled: this.props.disabled,
                appear: this.props.appear }), onClick: this._onClick, disabled: this.props.disabled, to: this.props.to },
            this.icon,
            " ",
            this.message || null,
            this.props.fileUpload ?
                React.createElement("input", { type: "file", ref: "fileInput", onChange: e => { if (this.props.action)
                        this.props.action(e); } }) :
                null));
    }
}
